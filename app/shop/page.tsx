...
export async function generateMetadata({ searchParams }: {
  ...
  let title = "Shop All Gadgets | Gadget Bazar BD";
  let description = "Browse our complete collection of gadgets and electronics at Gadget Bazar BD. Quality tech at unbeatable prices.";
