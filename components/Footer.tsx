                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-sm text-gray-600">customer.care@gadgetbazarbd.com</p>
                        </div>
                    ...
                    {/* Company Links */}
                    <div>
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-6">Gadget Bazar</h3>
                        <ul className="space-y-4">
                            <li><Link href="#" className="text-sm text-gray-500 hover:text-blue-600 transition-colors font-medium">About Us</Link></li>
                            <li><Link href="#" className="text-sm text-gray-500 hover:text-blue-600 transition-colors font-medium">Gadget Bazar Blog</Link></li>
