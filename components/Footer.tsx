            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-sm text-gray-600">support@healthportall.com</p>
                        </div>
                    ...
                    {/* Company Links */}
                    <div>
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-6">HealthPortall</h3>
                        <ul className="space-y-4">
                            <li><Link href="#" className="text-sm text-gray-500 hover:text-blue-600 transition-colors font-medium">About Us</Link></li>
                            <li><Link href="#" className="text-sm text-gray-500 hover:text-blue-600 transition-colors font-medium">HealthPortall Blog</Link></li>
                ...
                <div className="border-t border-gray-50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em]">
                        © {new Date().getFullYear()} HealthPortall. All rights reserved.
                    </p>
